---
name: phases
description: Turn an approved multi-phase plan into tracked phases (beads, else a STATE.md plan section) so /yah:where and the statusline show the current phase and PR. Use right after a plan is approved.
